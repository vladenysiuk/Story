...
CREATE TABLE public.price_change (
    ...
    product_regional_id integer NOT NULL,
    new_price numeric(6,3) NOT NULL,
    date date NOT NULL,
    old_price numeric(6,3) NOT NULL
);
...
CREATE TABLE public.product_regional (
    product_regional_id integer DEFAULT 0 NOT NULL,
    region_id integer DEFAULT 0 NOT NULL,
    sell_price numeric(6,3) DEFAULT 0.00 NOT NULL,
...
--
-- Name: sold_items; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.sold_items OWNER TO admin;
...
1047	1	2023-01-07	25
1048	1	2023-01-07	25
1049	1	2023-01-07	25
1050	1	2023-01-07	25
1051	1	2023-01-07	25
1052	1	2023-01-07	25
\.
...
1	1	324.000	2023-01-07	10.000
2	2	213.000	2023-01-07	5.000
3	13	324.000	2023-01-07	13.000
5	14	345.000	2023-01-07	17.000
7	14	148.000	2023-01-15	228.260
4	14	17.000	2023-01-06	16.990
6	14	228.255	2023-01-08	228.280
8	24	123.000	2023-01-07	123.000
\.
...
4	4	12.990	Product 4	11.99	5
5	5	6.750	Product 5	5.75	3
11	11	7.990	Product 11	6.99	3
3	3	8.500	Product 3	7.50	1
9	9	15.990	Product 9	14.99	5
7	7	7.990	Product 7	6.99	2
16	1	2.000	123	2.00	2
17	1	5.000	567	5.00	5
18	1	4.000	444	4.00	4
19	1	4.000	435	4.00	4
20	1	4.000	43543	4.00	4
21	2	2.000	Goofy	3.00	1
22	1	2.000	aboba	2.00	8
23	1	2.000	adsa	2.00	2
24	16	3.000	smurfik	2.00	1
12	12	10.990	Product 1212	9.99	5
8	8	11.530	Product 88	11.00	4123
10	10	8.750	Product 10	7.75	213
6	6	9.990	Product 6	40.00	3
15	15	11.750	Product 15	234.75	1
1	1	10.990	Product 1	324.00	3
2	2	5.990	Product 2	213.00	4
13	13	13.500	Product 13	324.00	6
14	14	17.990	Product 14	148.00	4
25	1	32.000	Product 228	123.00	1
\.
...
COPY public.sales_history (item_id, price, date, supermarket_id) FROM stdin;
1001	10.000	2023-06-01	1
1002	8.000	2023-06-02	2
1003	15.000	2023-06-03	3
1004	12.000	2023-06-04	4
1005	5.000	2023-06-05	5
1006	7.000	2023-06-06	6
1007	9.000	2023-06-07	7
1008	11.000	2023-06-08	8
1009	13.000	2023-06-09	9
1010	6.000	2023-06-10	10
1011	8.000	2023-06-11	11
1012	10.000	2023-06-12	12
1013	12.000	2023-06-13	13
1014	14.000	2023-06-14	14
1015	16.000	2023-06-15	15
25	32.000	2023-01-07	1
25	32.000	2023-01-07	1
25	32.000	2023-01-07	1
25	32.000	2023-01-07	1
25	32.000	2023-01-07	1
...
--
-- Data for Name: sold_items; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.sold_items (item_id, product_regional_id, sell_price, sell_date) FROM stdin;
1032	25	32	2023-01-07
1033	25	32	2023-01-07
\.
...
--
-- Name: sold_items sold_items_pk; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.sold_items
    ADD CONSTRAINT sold_items_pk PRIMARY KEY (item_id);
...
--
-- Name: sold_items product_regional_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
